    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-blue-600/10 overflow-hidden">
      ...
      <main className="relative">
        ...
        <motion.div 
          ...
          className="absolute top-0 right-0 w-1/3 h-[500px] bg-blue-50/50 blur-[120px] rounded-full pointer-events-none -z-10"
        ></motion.div>
        <motion.div 
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 2, delay: 0.5 }}
          className="absolute bottom-0 left-0 w-1/4 h-[400px] bg-slate-50 blur-[100px] rounded-full pointer-events-none -z-10"
        ></motion.div>
